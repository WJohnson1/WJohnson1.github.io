...
function setup(){
	...
	ball.addImage(loadImage("WJohnson1.github.io/Olympics/Rugby/ball.png")) 
	ball2 = createSprite(600,375,10,10)
  	ball2.shapeColor = color(102,51,0)
	ball2.addImage(loadImage("WJohnson1.github.io/Olympics/Rugby/ball.png"))   	
	...
	ball3 = createSprite(450,450,10,10)
  	...
  	ball3.addImage(loadImage("WJohnson1.github.io/Olympics/Rugby/ball.png")) 
	...
	ball4 = createSprite(150,500,10,10)
  	...
  	ball4.addImage(loadImage("WJohnson1.github.io/Olympics/Rugby/ball.png")) 
	...
	ball5 = createSprite(50,25,10,10)
  	...
  	ball5.addImage(loadImage("WJohnson1.github.io/Olympics/Rugby/ball.png")) 
	...
	wall4 = createSprite(675,600,1350,25)
  	...
  	player.addImage(loadImage("WJohnson1.github.io/Olympics/Rugby/player.png")) 
}
function draw(){
	if (homescreen === true) {
		background(0)

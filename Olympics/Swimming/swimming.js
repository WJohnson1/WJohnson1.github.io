...
function setup(){
	...
	createCanvas(1350,590)
  	...
  	opponent.shapeColor= color(0,0,255)
  	opponent1 = createSprite(25,185,25,25)
  	opponent1.shapeColor= color(0,0,255)
  	opponent2 = createSprite(25,260,25,25)
  	opponent2.shapeColor= color(0,0,255)
    opponent3 = createSprite(25,335,25,25)
  	opponent3.shapeColor= color(0,0,255)
    opponent4 = createSprite(25,410,25,25)
  	opponent4.shapeColor= color(0,0,255)
   	opponent5 = createSprite(25,485,25,25)
  	opponent5.shapeColor= color(0,0,255)
 	opponent6 = createSprite(25,560,25,25)
  	opponent6.shapeColor= color(0,0,255)
  	...
  	wall5.shapeColor = color(0,0,255)
  	wall6 = createSprite(0,375,2700, 10)
  	wall6.shapeColor = color(0,0,255)
  	wall7 = createSprite(0,450,2700, 10)
  	wall7.shapeColor = color(0,0,255)
  	wall8 = createSprite(0,525,2700, 10)
  	wall8.shapeColor = color(0,0,255)
  	wall9 = createSprite(0,600,2700, 10)
  	wall9.shapeColor = color(0,0,255)

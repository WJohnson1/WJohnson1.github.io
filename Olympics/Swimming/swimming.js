...
function setup(){
    ...
    usa = createSprite(325,150,25,25)
    russia = createSprite(650,150,25,25)
    brazil = createSprite(975,150,25,25)
    china = createSprite(270,300,25,25)
    australia = createSprite(540,300,25,25)
    france = createSprite(810,300,25,25)
    germany = createSprite(1080,300,25,25)
    greatb = createSprite(325,450,25,25)
    italy = createSprite(650,450,25,25)
    mexico = createSprite(975,450,25,25)
}
function draw(){
	if (countrymenu === true) {
